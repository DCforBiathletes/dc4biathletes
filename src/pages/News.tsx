...
function News() {
  return (
    <div>
      ...
      <div>
        <h2>DC4Biathletes at the IBU Youth and Junior World Championships</h2>
        <p>March 10, 2025 | Events</p>
        <p>The DC4Biathletes project was actively promoted at the Championships.</p>
      </div>
    </div>
  );
}
